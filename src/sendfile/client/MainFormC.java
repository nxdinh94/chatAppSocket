...
public class MainFormC extends javax.swing.JFrame {
    String username;
    String host;
    int port;
    Socket socket;
    ...
    */
    ...
    private void initComponents() {
        ...
        btn_sendChat.setBackground(new java.awt.Color(153, 153, 153));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MainFormC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
